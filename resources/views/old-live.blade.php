...
.camera-placeholder i { font-size: 48px; opacity: .25; }
...
.cam-btn:hover { background: rgba(255,255,255,.15); border-color: rgba(255,255,255,.3); }
.cam-btn.danger { background: rgba(239,68,68,.7); border-color: rgba(239,68,68,.5); }
.cam-btn.danger:hover { background: rgba(239,68,68,.9); }
...
.detail-icon {
    ...
    background: rgba(145,70,255,.1); border: 1px solid rgba(145,70,255,.15);
...
.price-value.price-flash {
    animation: priceflash .6s ease forwards;
}
...
.quick-btn:hover { border-color: var(--primary); color: var(--primary); background: rgba(145,70,255,.06); }
...
.bid-error {
    ...
    color: #f87171; border-radius: 8px; padding: 9px 12px;
...
@media(max-width:1100px) {
    .bid-sticky-bar { display: block; }
    .bid-column { display: none; }
}
...
.sticky-submit i { font-size: 15px; }

/* ═══════════════════════════════════════
   SECTION TABS (gallery / stream)
═══════════════════════════════════════ */
