<div id="kt_app_header" class="app-header modern-header" data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}">
    ...
    <div class="app-container container-xxl d-flex align-items-center justify-content-between" style="gap:8px; padding-left:12px; padding-right:12px;">
        ...
        <div class="d-flex align-items-center mhdr-search-wrap">
            <div class="search-box position-relative">
                <i class="bi bi-search search-icon"></i>
                <input type="text" class="form-control search-input" placeholder="Müzayede, ilan veya kullanıcı ara...">
            </div>
        </div>
        ...
        <div class="d-flex align-items-center" style="gap:4px; flex-shrink:0;">
            ...
            @auth
            @role('seller')
            <a href="#create-auction" class="btn btn-primary btn-sm modern-btn d-none d-lg-flex">
                <i class="bi bi-plus-lg me-1"></i>İlan Ver
            </a>
            <a href="#create-auction" class="btn modern-icon d-flex d-lg-none" style="color:#7F77DD">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end modern-dropdown">
                    <div class="user-box fw-semibold">Bildirimler</div>
                    <div class="text-center text-muted py-4">Yeni bildirim yok</div>
                </div>
            </div>
