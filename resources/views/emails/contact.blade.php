    ...
    <div style="max-width:560px;margin:40px auto;background:#171a2b;border-radius:16px;overflow:hidden;box-shadow:0 20px 60px rgba(0,0,0,.4)">
        ...
        <div style="padding:20px 30px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
                <tr>
                    ...
                    <td width="48%" style="background:#1e2235;border:1px solid #23263a;border-radius:12px;padding:14px 16px;">
                        ...
                        <div style="font-size:14px;font-weight:600;color:#8b5cf6;word-break:break-all;">{{ $email }}</div>
                    </td>
                </tr>
            </table>
            ...
            <div style="margin-bottom:16px;">
                ...
                <span style="display:inline-block;padding:5px 14px;border-radius:20px;background:rgba(124,58,237,.15);color:#8b5cf6;font-size:13px;font-weight:700;border:1px solid rgba(124,58,237,.25);">
                    {{ $subject }}
                </span>
            </div>
            ...
            <div style="text-align:center;">
                <a href="mailto:{{ $email }}" style="display:inline-block;padding:12px 26px;border-radius:10px;background:linear-gradient(135deg,#7c3aed,#4f46e5);color:#fff;font-weight:600;font-size:14px;text-decoration:none;box-shadow:0 10px 25px rgba(124,58,237,.35);">
                    Yanıtla →
                </a>
            </div>
