        ...
        <div class="d-flex flex-column gap-2">
            @foreach($notifications as $notif)
                @php
                    ...
                    $meta = match($type) {
                        'follow'           => ['bi-person-plus-fill',  '#7F77DD', 'rgba(127,119,221,.12)'],
                        ...
                        default            => ['bi-bell-fill',         '#7F77DD', 'rgba(127,119,221,.12)'],
                    };
                ...
                <a href="{{ $link }}"
                   class="notif-card {{ $unread ? 'unread' : '' }}">
                    ...
                    <div class="notif-avatar-wrap">
                        ...
                        @elseif($avatarName)
                            <div class="notif-avatar-letter" style="background:#7F77DD;">
