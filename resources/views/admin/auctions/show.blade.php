        ...
        <div class="col-lg-5">
            ...
            <div class="admin-card mb-3">
                ...
                <div class="p-3">
                    <div class="row g-2">
                        @foreach([
                            ['bi-currency-dollar', 'rgba(145,70,255,.12)', 'var(--primary)',  $auction->displayPrice(),                    'Mevcut Fiyat'],
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <img src="{{ $bid->user->avatar
                                        ...
                                        : 'https://ui-avatars.com/api/?name='.urlencode($bid->user->name).'&size=32&background=7c3aed&color=fff' }}"
